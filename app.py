...
if selected == "PRI":
   st.title(f"Has seleccionado {selected}")
   st.header("Diputados del Partido revolucionario Institucinal")
   st.subheader("")
   st.subheader("114: Abramo Masso Yerico")
   st.subheader("")
   image = Image.open('114.jpg')
   st.image(image)
   st.subheader("115: Aceves García Norma Angélica")
   st.subheader("")
   image = Image.open('115.jpg')
   st.image(image)
   st.subheader("116: Acosta Peña Brasil Alberto")
   st.subheader("")
   image = Image.open('116.jpg')
   st.image(image)
   st.subheader("117: Aguilar Castillo Ricardo")
   st.subheader("")
   image = Image.open('117.jpg')
   st.image(image)
   st.subheader("118: Aguilar Cifuentes Yeimi Yazmín")
   st.subheader("")
   image = Image.open('118.jpg')
   st.image(image)
   st.subheader("119: Aguirre Maldonado Ma. de Jesús")
   st.subheader("")
   image = Image.open('119.jpg')
   st.image(image)
   st.subheader("120: Alcalá Ruiz Blanca Maria del Socorro")
   st.subheader("")
   image = Image.open('120.jpg')
   st.image(image)
   st.subheader("121: Alcántara Rojas Maria Guadalupe")
   st.subheader("")
   image = Image.open('121.jpg')
   st.image(image)
   st.subheader("122: Amezcua González Cristina")
   st.subheader("")
   image = Image.open('122.jpg')
   st.image(image)
   st.subheader("123: Angulo Briceño Pablo Guillermo")
   st.subheader("")
   image = Image.open('123.jpg')
   st.image(image)
   
   #st.subheader("124: Arcos Velázquez Montserrat Alicia")
   #st.subheader("")
   #image = Image.open('124.jpg')
   #st.image(image)
   #st.subheader("125: Beauregard Martínez Carolina")
   #st.subheader("")
   #image = Image.open('125.jpg')
   #st.image(image)
   #st.subheader("126: Becerra Moreno Monica")
   #st.subheader("")
   #image = Image.open('126.jpg')
   #st.image(image)
   #st.subheader("127: Bolio Pinelo Kathia María")
   #st.subheader("")
   #image = Image.open('127.jpg')
   #st.image(image)
   #st.subheader("128: Campuzano González Gina Gerardina")
   #st.subheader("")
   #image = Image.open('128.jpg')
   #st.image(image)
   #st.subheader("129: Castell de Oro Palacios María Teresa")
   #st.subheader("")
   #image = Image.open('129.jpg')
   #st.image(image)
   #st.subheader("130: Castillo Olivares Héctor Israel")
   #st.subheader("")
   #image = Image.open('130.jpg')
   #st.image(image)
   #st.subheader("131: Castrellón Garza Francisco Javier")
   #st.subheader("")
   #image = Image.open('131.jpg')
   #st.image(image)
   #st.subheader("132: Chalé Cauich Sergio Enrrique")
   #st.subheader("")
   #image = Image.open('132.jpg')
   #st.image(image)
   #st.subheader("133: Cifuentes Negrete Román")
   #st.subheader("")
   #image = Image.open('133.jpg')
   #st.image(image)
   
   
   #st.subheader("134: Compeán Fernández Eliseo")
   #st.subheader("")
   #image = Image.open('134.jpg')
   #st.image(image)
   #st.subheader("135: Contreras Duarte Laura Patricia")
   #st.subheader("")
   #image = Image.open('135.jpg')
   #st.image(image)
   #st.subheader("136: CORDERO GONZALEZ WENDY M.")
   #st.subheader("")
   #image = Image.open('136.jpg')
   #st.image(image)
   #st.subheader("137: Creel Miranda Santiago")
   #st.subheader("")
   #image = Image.open('137.jpg')
   #st.image(image)
   #st.subheader("138: Díaz Villalón Erika de los Ángeles")
   #st.subheader("")
   #image = Image.open('138.jpg')
   #st.image(image)
   #st.subheader("139: Escudero Fabre María del Carmen")
   #st.subheader("")
   #image = Image.open('139.jpg')
   #st.image(image)
   #st.subheader("140: Espadas Galván Jorge Arturo")
   #st.subheader("")
   #image = Image.open('140.jpg')
   #st.image(image)
   #st.subheader("141: Esquivel Arrona Ana María")
   #st.subheader("")
   #image = Image.open('141.jpg')
   #st.image(image)
   #st.subheader("142: Felipe Torres Joanna Alejandra")
   #st.subheader("")
   #image = Image.open('142.jpg')
   #st.image(image)
   #st.subheader("143: Galarza Castro Yesenia")
   #st.subheader("")
   #image = Image.open('143.jpg')
   #st.image(image)
   
   
   #st.subheader("144: Gamboa Torales María Josefina")
   #st.subheader("")
   #image = Image.open('144.jpg')
   #st.image(image)
   #st.subheader("145: García García José Antonio")
   #st.subheader("")
   #image = Image.open('145.jpg')
   #st.image(image)
   #st.subheader("146: Garcia Velasco Anabey")
   #st.subheader("")
   #image = Image.open('146.jpg')
   #st.image(image)
   #st.subheader("147: Garza Treviño Pedro")
   #st.subheader("")
   #image = Image.open('147.jpg')
   #st.image(image)
   #st.subheader("148: Godínez del Rio Enrique")
   #st.subheader("")
   #image = Image.open('148.jpg')
   #st.image(image)
   #st.subheader("149: Gómez Cárdenas Annia Sarahí")
   #st.subheader("")
   #image = Image.open('149.jpg')
   #st.image(image)
   #st.subheader("150: Gómez del Campo Gurza Mariana")
   #st.subheader("")
   #image = Image.open('150.jpg')
   #st.image(image)
   #st.subheader("151: González Alonso Carmen Rocío")
   #st.subheader("")
   #image = Image.open('151.jpg')
   #st.image(image)
   #st.subheader("152: González Azcárraga Rosa María")
   #st.subheader("")
   #image = Image.open('152.jpg')
   #st.image(image)
   #st.subheader("153: González Márquez Karen Michel")
   #st.subheader("")
   #image = Image.open('153.jpg')
   #st.image(image)
   
  
   #st.subheader("154: González Urrutia Wendy")
   #st.subheader("")
   #image = Image.open('154.jpg')
   #st.image(image)
   #st.subheader("155: González Zepeda Javier")
   #st.subheader("")
   #image = Image.open('155.jpg')
   #st.image(image)
   #st.subheader("156: Gutiérrez Valdez María de los Angeles")
   #st.subheader("")
   #image = Image.open('156.jpg')
   #st.image(image)
   #st.subheader("157: Gutierrez Valtierra Diana Estefania")
   #st.subheader("")
   #image = Image.open('157.jpg')
   #st.image(image)
   #st.subheader("158: Hernández Escobar Alma Rosa")
   #st.subheader("")
   #image = Image.open('158.jpg')
   #st.image(image)
   #st.subheader("159: Huerta Ling Guillermo Octavio")
   #st.subheader("")
   #image = Image.open('159.jpg')
   #st.image(image)
   #st.subheader("160: Huerta Villegas Genoveva")
   #st.subheader("")
   #image = Image.open('160.jpg')
   #st.image(image)
   #st.subheader("161: Inzunza Armas Jorge Ernesto")
   #st.subheader("")
   #image = Image.open('161.jpg')
   #st.image(image)
   #st.subheader("162: Jiménez Angulo Julia Licet")
   #st.subheader("")
   #image = Image.open('162.jpg')
   #st.image(image)
   #st.subheader("163: Juárez Navarrete Berenice")
   #st.subheader("")
   #image = Image.open('163.jpg')
   #st.image(image)
   
   
   
   #st.subheader("164: Lara Carreón Diana María Teresa")
   #st.subheader("")
   #image = Image.open('164.jpg')
   #st.image(image)
   #st.subheader("165: Lixa Abimerhi José Elías")
   #st.subheader("")
   #image = Image.open('165.jpg')
   #st.image(image)
   #st.subheader("166: Lopez Sosa Mariela")
   #st.subheader("")
   #image = Image.open('166.jpg')
   #st.image(image)
   #st.subheader("167: Loyola Vera Ignacio")
   #st.subheader("")
   #image = Image.open('167.jpg')
   #st.image(image)
   #st.subheader("168: Luna Ayala Noemi Berenice")
   #st.subheader("")
   #image = Image.open('168.jpg')
   #st.image(image)
   #st.subheader("169: Macías Olvera Felipe Fernando")
   #st.subheader("")
   #image = Image.open('169.jpg')
   #st.image(image)
   #st.subheader("170: Macías Zambrano Gustavo")
   #st.subheader("")
   #image = Image.open('170.jpg')
   #st.image(image)
   #st.subheader("171: Madrazo Limón Carlos")
   #st.subheader("")
   #image = Image.open('171.jpg')
   #st.image(image)
   #st.subheader("172: Mandujano Tinajero Esther")
   #st.subheader("")
   #image = Image.open('172.jpg')
   #st.image(image)
   #st.subheader("173: Martínez López Paulo Gonzalo")
   #st.subheader("")
   #image = Image.open('173.jpg')
   #st.image(image)
   
   
   #st.subheader("174: Mata Atilano Noel")
   #st.subheader("")
   #image = Image.open('174.jpg')
   #st.image(image)
   #st.subheader("175: Mata Carrasco Mario")
   #st.subheader("")
   #image = Image.open('175.jpg')
   #st.image(image)
   #st.subheader("176: Mata Lozano Lizbeth")
   #st.subheader("")
   #image = Image.open('176.jpg')
   #st.image(image)
   #st.subheader("177: Maturino Manzanera Juan Carlos")
   #st.subheader("")
   #image = Image.open('177.jpg')
   #st.image(image)
   #st.subheader("178: Mendoza Acevedo Luis Alberto")
   #st.subheader("")
   #image = Image.open('178.jpg')
   #st.image(image)
   #st.subheader("179: Monraz Ibarra Miguel Angel")
   #st.subheader("")
   #image = Image.open('179.jpg')
   #st.image(image)
   #st.subheader("180: Montes Estrada Berenice")
   #st.subheader("")
   #image = Image.open('180.jpg')
   #st.image(image)
   #st.subheader("181: Morales Flores Jesús Fernando")
   #st.subheader("")
   #image = Image.open('181.jpg')
   #st.image(image)
   #st.subheader("182: Murillo Manríquez Sonia")
   #st.subheader("")
   #image = Image.open('182.jpg')
   #st.image(image)
   #st.subheader("183: Núñez Cerón Sarai")
   #st.subheader("")
   #image = Image.open('183.jpg')
   #st.image(image)
